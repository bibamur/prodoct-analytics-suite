...
def load_event_types(config_path: str) -> Dict:
...
if __name__ == '__main__':
    ...
    event_types = load_event_types('../event_counts/event_counts_config.json')
    events.data = uev.filter_by_event_type(events, event_types, add_event_type_name=True)
